  ...
  return (
    <>
      ...
      >
        <svg
          className={twMerge(
            "h-8 w-8 fill-primary text-primary hover:fill-accent",
            iconClassname,
          )}
                ...
                >
                  ...
                  >
                    <path
                      fill="currentColor"
                      fillRule="evenodd"
                      d="M807.186 686.592l272.864 272.864H0v112.94h1080.05l-272.864 272.978 79.736 79.849 409.296-409.183-409.296-409.184-79.736 79.736zM1870.419 434.69l-329.221-329.11C1509.688 74.07 1465.979 56 1421.48 56H451.773v730.612h112.94V168.941h790.584v451.762h451.762v1129.405H564.714v-508.233h-112.94v621.173H1920V554.52c0-45.176-17.619-87.754-49.58-119.83zm-402.181-242.37l315.443 315.442h-315.443V192.319z"
                    ></path>
                  </svg>
                </label>
